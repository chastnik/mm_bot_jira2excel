...
3. Введите ваш email для подключения к Jira
4. Введите ваш API токен для Jira
...
3. Введите дату начала периода в формате `YYYY-MM-DD`
4. Введите дату окончания периода в формате `YYYY-MM-DD`
